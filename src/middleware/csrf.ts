...
/** Generate a UUID v4 using Web Crypto API (Edge-compatible, no npm dependency) */
 ...
 */
export function handleCsrf(request: NextRequest, _response?: NextResponse) {
  ...
  if (
    ...
    path.startsWith('/api/v1/market/analyze') ||
    path.startsWith('/api/v1/user/verify-account')
  ) {
    return null;
  }
