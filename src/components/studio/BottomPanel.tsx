...
import type { BacktestResult } from '@/lib/algo/backtest-engine';
          ...
          >
            ...
            <div className="w-64 border-r border-white/10 p-4 flex flex-col justify-center gap-4 bg-zinc-900/30">
              <div>
                ...
                <p
                  className={`text-2xl font-mono font-bold flex items-center gap-1 ${totalPnL >= 0 ? 'text-emerald-400' : 'text-red-400'}`}
                >
                  {totalPnL >= 0 ? '+' : ''}
                  {totalPnL.toFixed(2)} <TrendingUp className="w-4 h-4" />
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-xs font-mono text-zinc-400">
                  {results ? 'Simulation Complete' : 'Waiting for run...'}
                </p>
              </div>
            </div>
