...
import { ChevronLeft, ChevronRight, Crown, LogOut, Users, Zap } from 'lucide-react';
...
import { type MenuId, useUserTier } from '@/hooks/useUserTier';
                ...
                >
                  ...
                  <item.icon
                    className={cn(
                      ...
                      isActive ? 'text-[#00FF94]' : 'text-gray-500 group-hover:text-white',
                    )}
                  />
                  ...
                  {isLocked && !isCollapsed && <Crown className="h-3 w-3 text-yellow-500 ml-auto animate-pulse" />}
                </Link>
              );
            })}
          </>
      ...
      {isFree && !loading && (
        <div className="px-3 pb-4">
          ...
          >
            ...
            {!isCollapsed && <span className="text-sm relative z-10 whitespace-nowrap">Upgrade to Pro</span>}
          </Link>
        </div>
      )}
