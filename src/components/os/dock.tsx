...
import { BarChart3, Home, Shield, Terminal } from "lucide-react";
...
export function Dock() {
    ...
    const hoveredApp = null; // Simplified for now
                    ...
                    return (
                        <Link
                            ...
                            className={cn(
                                ...
                                isActive ? "bg-white/20 text-white shadow-lg shadow-white/10" : "text-gray-400 hover:bg-white/10 hover:text-white"
                            )}
                        >
                            {item.icon}
