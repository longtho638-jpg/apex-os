      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="relative group">
          ...
          <div className="relative bg-[#0A0A0A] border border-white/10 rounded-xl p-8 md:p-12 text-center overflow-hidden">
            ...
            <h1 className="relative text-4xl md:text-5xl font-bold text-white mb-4 tracking-tight">{title}</h1>

            <p className="relative text-lg text-gray-400 mb-8 max-w-lg mx-auto">{description}</p>
