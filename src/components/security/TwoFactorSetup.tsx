    ...
    <GlassCard className="p-6 max-w-md mx-auto">
      ...
      {step === 'init' && (
        <div className="text-center">
          <p className="text-zinc-400 mb-6">Secure your account with Google Authenticator.</p>
          <button
            onClick={startSetup}
            disabled={loading}
      ...
      {step === 'scan' && (
        <div className="space-y-4">
          ...
          <p className="text-xs text-center text-zinc-500 font-mono break-all">Secret: {secret}</p>
