...
export default function DeFiPortfolio() {
    ...
    const mockTokens = [
        { symbol: 'USDT', balance: '1,250.00', value: 1250.00 },
        { symbol: 'USDC', balance: '500.00', value: 500.00 },
        { symbol: 'LINK', balance: '45.50', value: 682.50 },
    ];
        ...
        return (
            <div className="glass-panel p-6 rounded-xl border border-white/10 flex flex-col items-center justify-center text-center space-y-4 min-h-[300px]">
                ...
                <div>
                    ...
                    <p className="text-gray-400 max-w-xs mx-auto mt-2">Connect your wallet to view on-chain assets and execute DeFi swaps directly from Apex OS.</p>
                </div>
                <WalletConnectButton />
            </div>
        );
        ...
        <div className="glass-panel p-6 rounded-xl border border-white/10">
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-xs text-gray-400 font-mono mt-1">{address?.slice(0, 6)}...{address?.slice(-4)}</p>
                </div>
                <WalletConnectButton />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div className="p-4 bg-white/5 rounded-xl border border-white/5">
                    ...
                    <div className="text-xs text-gray-500 mt-1">
                        ≈ ${(Number(ethFormatted) * 3000).toLocaleString()}
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-3">
                ...
                {mockTokens.map((token) => (
                    <div key={token.symbol} className="flex items-center justify-between p-3 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
