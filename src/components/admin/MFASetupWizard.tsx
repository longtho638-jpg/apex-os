...
import { Shield, Key, Download, CheckCircle2, AlertCircle, Copy, Loader2 } from 'lucide-react';
    ...
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-2 mb-8">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${step === 'setup' || step === 'verify' || step === 'recovery' || step === 'complete'
                        ? 'bg-emerald-500 text-white'
                        : 'bg-white/10 text-gray-500'
                    }`}>
                    1
                </div>
                <div className={`w-12 h-0.5 ${step === 'verify' || step === 'recovery' || step === 'complete'
                        ? 'bg-emerald-500'
                        : 'bg-white/10'
                    }`} />
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${step === 'verify' || step === 'recovery' || step === 'complete'
                        ? 'bg-emerald-500 text-white'
                        : 'bg-white/10 text-gray-500'
                    }`}>
                    2
                </div>
                <div className={`w-12 h-0.5 ${step === 'recovery' || step === 'complete'
                        ? 'bg-emerald-500'
                        : 'bg-white/10'
                    }`} />
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${step === 'recovery' || step === 'complete'
                        ? 'bg-emerald-500 text-white'
                        : 'bg-white/10 text-gray-500'
                    }`}>
                    3
