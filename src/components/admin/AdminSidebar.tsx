...
export function AdminSidebar() {
  ...
  const navItems = [
    ...
    },
    {
      ...
      icon: Users,
      children: [{ name: t('viral'), href: '/admin/viral-economics', icon: Users }],
    },
  ...
  return (
    <div className="w-64 h-screen bg-black border-r border-gray-800 flex flex-col">
      ...
      <div className="p-6 border-b border-gray-800">
        <div className="flex items-center gap-2 text-[#00FF94]">
          ...
          <span className="text-xl font-bold tracking-wider">
            APEX<span className="text-white">GOD</span>
          </span>
        </div>
            ...
            <div key={item.href}>
              ...
              >
                <div className="flex items-center gap-3">
                  <item.icon
                    className={cn('w-5 h-5', isActive ? 'text-[#00FF94]' : 'text-gray-500 group-hover:text-white')}
                  />
      ...
      <div className="p-4 border-t border-gray-800">
        ...
        <Link
          href="/dashboard"
          className="flex items-center gap-2 text-gray-500 hover:text-white transition-colors w-full px-2 py-2 mb-2"
        >
