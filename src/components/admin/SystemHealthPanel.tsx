...
export default function SystemHealthPanel() {
    ...
    if (loading) {
        return <Card><CardContent className="p-6 animate-pulse"><div className="h-40 bg-gray-200 rounded"></div></CardContent></Card>;
    }

    if (!health) {
        return <Card><CardContent className="p-6">{t('failed_load')}</CardContent></Card>;
    }
