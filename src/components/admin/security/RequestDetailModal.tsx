...
export default function RequestDetailModal({ request, onClose, onComplete, currentUserId }: RequestDetailModalProps) {
    ...
    const isRequester = request.requester.email === currentUserId; // Assuming email match or ID match if available

    const handleApprove = async () => {
        if (!confirm('Are you sure you want to approve this request? This action is recorded on the blockchain (audit log).')) return;
