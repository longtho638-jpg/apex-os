...
import { DollarSign, TrendingUp, Brain, Zap } from 'lucide-react';
    ...
    const renderWithBold = (text: string) => {
        ...
        return parts.map((part, index) => {
            if (part.startsWith('**') && part.endsWith('**')) {
                return <strong key={index} className="text-gray-300">{part.slice(2, -2)}</strong>;
            }
                        ...
                        <div key={tier.name} className="space-y-4">
                            ...
                            <div className="relative pt-1">
                                <input
                                    ...
                                    max="100"
                                    value={tier.rebate}
                                    onChange={(e) => handleRebateChange(index, parseInt(e.target.value))}
