...
import { Settings, Save, Play, Pause, Activity } from 'lucide-react';
                    ...
                    <div key={strategy.id} className="bg-white/5 border border-white/10 rounded-xl p-6">
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                <div className={`h-3 w-3 rounded-full ${strategy.status === 'ACTIVE' ? 'bg-green-500 animate-pulse' : 'bg-yellow-500'}`} />
                                <div>
