...
import { Brain, TrendingUp, TrendingDown, AlertTriangle, Target, Shield, ChevronRight, Loader2, RefreshCw } from 'lucide-react';
    ...
    const analyzeMarket = async () => {
        ...
        try {
            ...
            setStrategy({
                ...
                reasoning: "Strong institutional buying pressure detected near $98k support. Order flow shows aggressive market buys. Breakout above $99k likely triggers liquidation cascade."
            });
        } finally {
            setLoading(false);
        }
                ...
                {strategy && !loading && (
                    ...
                    >
                        ...
                        <div className={cn(
                            ...
                            strategy.signal === 'LONG' ? "bg-green-500/10 border-green-500/20" :
                                strategy.signal === 'SHORT' ? "bg-red-500/10 border-red-500/20" :
                            ...
                            <div className="relative z-10">
                                ...
                                <div className={cn(
                                    ...
                                    strategy.signal === 'LONG' ? "text-green-400" :
                                        strategy.signal === 'SHORT' ? "text-red-400" : "text-zinc-400"
                                )}>
                                    {strategy.signal}
                            ...
                            <div className={cn(
                                ...
                                strategy.signal === 'LONG' ? "bg-green-500" :
                                    strategy.signal === 'SHORT' ? "bg-red-500" : "bg-zinc-500"
                            )} />
                        </div>
