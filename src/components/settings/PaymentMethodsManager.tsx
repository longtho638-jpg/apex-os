    ...
    const handleAdd = async () => {
        ...
        try {
            ...
            const payload = {
                type: newMethod.type,
                name: newMethod.name,
                details: newMethod.type === 'crypto_wallet'
                    ? { address: newMethod.details.address, network: newMethod.details.network }
                    : { bank_name: newMethod.details.bank_name, account_number: newMethod.details.account_number, account_holder: newMethod.details.account_holder },
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={e => setNewMethod({ ...newMethod, details: { ...newMethod.details, network: e.target.value } })}
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={e => setNewMethod({ ...newMethod, details: { ...newMethod.details, address: e.target.value } })}
                                        placeholder="0x..."
                                        className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-white outline-none focus:border-emerald-500/50"
                                    />
                                </div>
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={e => setNewMethod({ ...newMethod, details: { ...newMethod.details, bank_name: e.target.value } })}
                                            className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-white outline-none focus:border-emerald-500/50"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={e => setNewMethod({ ...newMethod, details: { ...newMethod.details, account_number: e.target.value } })}
                                            className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-white outline-none focus:border-emerald-500/50"
                                        />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={e => setNewMethod({ ...newMethod, details: { ...newMethod.details, account_holder: e.target.value } })}
                                        className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-white outline-none focus:border-emerald-500/50"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="font-bold text-white flex items-center gap-2">
                                        {method.name}
                                        {method.is_default && <span className="text-[10px] bg-emerald-500/20 text-emerald-400 px-2 py-0.5 rounded-full">Default</span>}
                                    </div>
