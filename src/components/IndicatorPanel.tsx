                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateIndicator('sma', { period: parseInt(e.target.value, 10) })}
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateIndicator('ema', { period: parseInt(e.target.value, 10) })}
                      className="flex-1 px-2 py-1 text-xs bg-white/5 border border-white/10 rounded"
                    />
                  </div>
                  <div className="flex items-center gap-2">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateIndicator('rsi', { period: parseInt(e.target.value, 10) })}
                      className="flex-1 px-2 py-1 text-xs bg-white/5 border border-white/10 rounded"
                    />
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateIndicator('rsi', { overbought: parseInt(e.target.value, 10) })}
                      className="flex-1 px-2 py-1 text-xs bg-white/5 border border-white/10 rounded"
                    />
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateIndicator('rsi', { oversold: parseInt(e.target.value, 10) })}
                      className="flex-1 px-2 py-1 text-xs bg-white/5 border border-white/10 rounded"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateIndicator('macd', { fast: parseInt(e.target.value, 10) })}
                      className="flex-1 px-2 py-1 text-xs bg-white/5 border border-white/10 rounded"
                    />
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateIndicator('macd', { slow: parseInt(e.target.value, 10) })}
                      className="flex-1 px-2 py-1 text-xs bg-white/5 border border-white/10 rounded"
                    />
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateIndicator('macd', { signal: parseInt(e.target.value, 10) })}
                      className="flex-1 px-2 py-1 text-xs bg-white/5 border border-white/10 rounded"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateIndicator('bb', { period: parseInt(e.target.value, 10) })}
                      className="flex-1 px-2 py-1 text-xs bg-white/5 border border-white/10 rounded"
                    />
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateIndicator('bb', { stdDev: parseInt(e.target.value, 10) })}
                      className="flex-1 px-2 py-1 text-xs bg-white/5 border border-white/10 rounded"
                    />
                  </div>
                </div>
              ...
              {settings.atr.enabled && (
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    onChange={(e) => updateIndicator('atr', { period: parseInt(e.target.value, 10) })}
                    className="flex-1 px-2 py-1 text-xs bg-white/5 border border-white/10 rounded"
                  />
                </div>
              )}
