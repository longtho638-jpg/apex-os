    ...
    return (
        <div className={cn(
            ...
            {phase.uiRoute && phase.uiRoute !== '#' ? (
                ...
                <button disabled className="w-full py-2 text-center text-xs font-bold rounded bg-gray-800 text-gray-600 cursor-not-allowed border border-gray-800">
                    NO WEB UI
                </button>
            )}
        </div>
