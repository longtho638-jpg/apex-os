...
import { generateFakeCandles, generateFakeTrades, generateFakePriceHistory } from '@/lib/utils/testDataGenerator';
...
export function TestConsole() {
    ...
    const runTests = async () => {
        ...
        try {
            ...
            results.push({ name: 'Generate Price History', status: 'fail', details: e.message });
        }
        ...
        try {
            ...
            results.push({ name: 'EMA Calculations', status: 'fail', details: e.message });
        }
        ...
        try {
            ...
            results.push({ name: 'MACD Calculation', status: 'fail', details: e.message });
        }
        ...
        try {
            ...
            results.push({ name: 'ATR Calculation', status: 'fail', details: e.message });
        }
        ...
        try {
            ...
            results.push({ name: 'Portfolio Returns', status: 'fail', details: e.message });
        }
