...
export function LiveStats() {
    ...
    return (
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-white/10 pt-12">
            ...
            <div>
                <div className="text-3xl font-black text-white mb-1"><AnimatedNumber value={4} /> Levels</div>
                <div className="text-xs text-zinc-500 uppercase tracking-widest">Viral Depth</div>
            </div>
            <div>
                <div className="text-3xl font-black text-white mb-1"><AnimatedNumber value={99.99} suffix="%" /></div>
