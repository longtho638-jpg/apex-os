                ...
                <div className="grid md:grid-cols-4 gap-12 mb-16">
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="p-2 bg-white/5 rounded-lg hover:bg-white/10 transition-colors hover:text-emerald-400"><Twitter className="w-5 h-5" /></a>
                            <a href="#" className="p-2 bg-white/5 rounded-lg hover:bg-white/10 transition-colors hover:text-emerald-400"><Linkedin className="w-5 h-5" /></a>
                            <a href="#" className="p-2 bg-white/5 rounded-lg hover:bg-white/10 transition-colors hover:text-emerald-400"><Github className="w-5 h-5" /></a>
                        </div>
                    </div>
                        ...
                        <div key={i}>
                            ...
                            <ul className="space-y-4 text-sm text-zinc-400">
                                {col.links.map((link, j) => (
                                    <li key={j}>
                                        <a href={link.href} className="hover:text-emerald-400 transition-colors flex items-center gap-2 group">
