...
export function Button3D({
  ...
  const getVariantStyles = () => {
    switch (variant) {
      ...
      case 'glass':
        return 'bg-[rgba(255,255,255,0.1)] text-white backdrop-blur-md border border-[rgba(255,255,255,0.1)]';
      default:
        return 'bg-emerald-600 text-white';
    }
  };
  ...
  return (
    ...
    >
      ...
      <div
        className={
          'absolute inset-0 rounded-xl bg-gradient-to-r from-emerald-600 to-cyan-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300'
        }
      />
