  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-4xl mx-auto mt-12">
      {stats.map((stat, i) => (
        <div
          key={i}
          className="bg-white/5 border border-white/5 rounded-xl p-4 backdrop-blur-sm flex flex-col items-center text-center group hover:bg-white/10 transition-colors"
        >
