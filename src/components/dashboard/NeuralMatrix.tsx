...
export const NeuralMatrix = memo(({ macroTrend, microRsi, macroRsi, netVolumeDelta, confidence, isActive }: NeuralMatrixProps) => {
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className={`text-[10px] font-bold ${macroTrend === 'BULLISH' ? 'text-emerald-400' :
                                macroTrend === 'BEARISH' ? 'text-red-400' : 'text-zinc-400'
                                }`}>
                                {macroTrend}
                            </span>
                        </div>
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-1">
                            ...
                            <span className={`text-[10px] font-mono font-bold ${netVolumeDelta >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
                                {netVolumeDelta >= 0 ? '+' : ''}{(netVolumeDelta / 1000).toFixed(0)}k
                            </span>
                        </div>
