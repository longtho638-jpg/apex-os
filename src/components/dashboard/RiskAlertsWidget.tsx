...
export function RiskAlertsWidget() {
    ...
    const getColor = (type: string) => {
        switch (type) {
            ...
            case 'INFO': return 'text-blue-500 border-blue-500/20 bg-blue-500/5';
                ...
                {alerts.map((alert, index) => (
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-zinc-400 leading-tight mb-1">
                                {alert.message}
                            </p>
