...
import type { ElementProfile, TraderDNA } from '@/lib/constants/zen-modes';
  ...
  return (
    <>
      ...
      <div className="text-center space-y-2">
        <div className="text-[9px] font-mono text-gray-500">{t('primary_element')}</div>
        <div
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="border border-cyan-500/30 bg-black/40 p-3">
          ...
          {isAlphaWindow && <div className="text-[9px] text-green-400 mt-1">● {t('active')}</div>}
        </div>
        ...
        <div className="border border-magenta-500/30 bg-black/40 p-3">
          ...
          <div className="font-mono text-xl font-bold">{traderDNA.winRate}%</div>
        </div>
      </div>

      {/* Counter Element */}
      <div className="border border-yellow-500/30 bg-yellow-500/5 p-3">
        <div className="text-[9px] font-mono text-gray-400 mb-1">{t('nemesis_element')}</div>
        <div className="font-mono text-xs text-yellow-400">{primaryElement.counterElement}</div>
      </div>

      {/* Nemesis Pair */}
      <div className="border border-red-500/30 bg-red-500/5 p-3">
        <div className="text-[9px] font-mono text-gray-400 mb-1">{t('nemesis_pair')}</div>
