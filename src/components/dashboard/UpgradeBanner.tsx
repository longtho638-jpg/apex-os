...
export default function UpgradeBanner({ message, ctaText, variant = 'default' }: UpgradeBannerProps) {
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-yellow-500">{t('limited_offer')}</span>
              <span className="text-xs text-zinc-400">{t('spots_left')}</span>
            </div>

            <h3 className="text-xl font-bold text-zinc-100 mb-2">{message || t('message')}</h3>

            <div className="flex flex-wrap gap-3 text-sm text-zinc-300 mb-4">
              <span className="flex items-center gap-1">✅ {t('feature_sync')}</span>
              <span className="flex items-center gap-1">✅ {t('feature_auditor')}</span>
              <span className="flex items-center gap-1">✅ {t('feature_guardian')}</span>
              <span className="flex items-center gap-1">✅ {t('feature_ref')}</span>
            </div>
          </div>
