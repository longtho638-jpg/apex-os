...
import type { ReturnsSeries, RiskMetrics } from '@/lib/risk/types';
...
export function usePortfolioRisk({
  ...
  }, [returns.length, enabled, cumulativeReturns, refreshIntervalMs, returns]); // Only re-run when returns count or enabled changes
