...
import { decrypt, decryptApiCredentials, encrypt, encryptApiCredentials } from '../lib/crypto/vault';
...
function testEncryption() {
  ...
  try {
    ...
    const decryptedCreds = decryptApiCredentials(encryptedCreds.encryptedKey, encryptedCreds.encryptedSecret);
