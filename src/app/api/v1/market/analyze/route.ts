...
const DEFAULT_RATES: Record<string, { maker: number; taker: number; apex_rebate: number }> = {
    'Binance': { maker: 0.001, taker: 0.001, apex_rebate: 0.10 },
    'OKX': { maker: 0.0008, taker: 0.001, apex_rebate: 0.40 },
    'Bybit': { maker: 0.001, taker: 0.001, apex_rebate: 0.30 },
    'Gate.io': { maker: 0.002, taker: 0.002, apex_rebate: 0.40 },
    'Bitget': { maker: 0.001, taker: 0.001, apex_rebate: 0.50 }
};
