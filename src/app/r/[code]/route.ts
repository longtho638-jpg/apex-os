...
export async function GET(
    ...
    try {
        ...
        let destinationUrl = provider.referral_link_template || 'https://apex.finance'; // Fallback
        ...
        if (campaign && campaign.variations && campaign.variations.length > 0) {
        ...
        if (provider.referral_link_template && provider.referral_link_template.startsWith('http')) {
