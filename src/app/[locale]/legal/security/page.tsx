...
export default function SecurityPage() {
  return (
    <LegalPageLayout title="Security Policy" lastUpdated="December 1, 2025">
      ...
      <p>
        Our infrastructure is hosted on AWS with strict VPC isolation and DDoS protection. We conduct regular
        penetration testing and security audits.
      </p>

      <h3>2. Account Protection</h3>
      <p>
        We mandate 2FA for all withdrawals and sensitive account changes. We also support WebAuthn for hardware key
        authentication.
      </p>

      <h3>3. Responsible Disclosure</h3>
      <p>
        If you discover a security vulnerability, please report it to security@apexrebate.com. We offer a bug bounty
        program for valid disclosures.
      </p>
    </LegalPageLayout>
  );
}
