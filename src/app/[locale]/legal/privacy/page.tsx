    ...
    return (
        <LegalPageLayout title="Privacy Policy" lastUpdated="December 1, 2025">
            ...
            <p>
                ...
                This may include your name, email address, and trading history.
            </p>

            <h3>2. Use of Information</h3>
            <p>
                We use the information we collect to operate, maintain, and improve our services, as well as to communicate with you about updates and promotions.
            </p>

            <h3>3. Data Sharing</h3>
            <p>
                We do not sell your personal data. We may share your information with third-party service providers who assist us in operating our platform,
