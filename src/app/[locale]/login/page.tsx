...
import { ChevronRight, Globe, Lock, ShieldCheck, Terminal } from 'lucide-react';
      ...
      >
        <div className="glass-panel rounded-2xl p-8 md:p-10 shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-white/10 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <WebAuthnLoginButton email={email} onSuccess={() => router.push(`/${locale}/dashboard`)} />
          </form>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-600">
            By accessing ApexOS, you agree to our{' '}
