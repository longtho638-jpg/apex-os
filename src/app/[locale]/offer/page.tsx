...
import { Check, Crown, Zap, TrendingUp, Users, AlertCircle, Calculator, Rocket } from 'lucide-react';
...
export default function OfferPage() {
    ...
    const APEX_COMMISSION_SHARE = 0.40;
                ...
                <div className="relative z-10 max-w-7xl mx-auto w-full px-6 py-12">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">
                            Trade More. <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00FF94] to-cyan-400">Earn More. Pay Nothing.</span>
                        </h1>
                        <p className="text-zinc-400 max-w-2xl mx-auto text-lg">
                            $0/mo forever. Tiers unlock automatically via trading volume.
                            Every trade earns you <span className="text-[#00FF94] font-bold">spread rebates</span> and
                                ...
                                <div className="lg:col-span-4 space-y-8">
                                    ...
                                    <div className="p-4 rounded-xl bg-white/5 border border-white/10 text-sm text-zinc-400">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <p>
                                                <span className="text-white font-bold">Zero fees.</span> You never pay a subscription. Earnings are pure profit from spread rebates + referral commissions.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className={`pt-3 border-t border-white/10`}>
                                                    ...
                                                    <div className="text-xl font-black text-[#00FF94]">
                            ...
                            >
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="text-xs text-[#00FF94] mt-1 font-medium">
                                        {tier.volumeRange} volume to unlock
                                    </div>
                                </div>
