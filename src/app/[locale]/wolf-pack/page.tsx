...
import { Check, Copy, TrendingUp, UserPlus, Users } from 'lucide-react';
...
export default function WolfPackPage() {
  ...
  const tierBonus = tier === 'SOVEREIGN' ? 20 : tier === 'ARCHITECT' ? 10 : tier === 'OPERATOR' ? 5 : 0;
            ...
            <div className="space-y-6">
              ...
              {data.in_pack ? (
                <>
                  ...
                  <div className="grid grid-cols-3 gap-6">
                    <div className="glass-card rounded-xl p-6">
                      ...
                      <div className="text-2xl font-bold text-white">{data.member_count}</div>
                    </div>
                    ...
                    <div className="glass-card rounded-xl p-6">
                      ...
                      <div className="text-2xl font-bold text-white">${data.total_volume.toLocaleString()}</div>
                    </div>
                    ...
                    <div className="glass-card rounded-xl p-6">
                      ...
                      <div className="text-2xl font-bold text-[#00FF94]">${data.shared_rebates.toFixed(2)}</div>
                      <div className="text-xs text-emerald-400 mt-1">+{tierBonus}% Tier Bonus Active</div>
                    </div>
                  </div>
                        ...
                        <tbody className="text-sm">
                          {data.members.map((member, idx) => (
                            <tr key={idx} className="border-b border-white/5 hover:bg-white/5">
                              <td className="py-3 font-mono text-gray-300">{member.user_id.slice(0, 8)}...</td>
                              <td className="py-3">
                                <span
                                  className={cn(
                              ...
                              <td className="py-3 text-zinc-400">{new Date(member.joined_at).toLocaleDateString()}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                ...
                <div className="glass-card rounded-xl p-12 text-center">
                  ...
                  <p className="text-zinc-400 mb-6 max-w-md mx-auto">{t('join_pack_desc')}</p>
