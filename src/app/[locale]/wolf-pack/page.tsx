            ...
            <main className="flex-1 flex flex-col overflow-hidden">
                ...
                <header className="h-16 flex items-center justify-between px-6 z-10 border-b border-white/5 bg-[#030303]/50 backdrop-blur-md">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-lg font-bold tracking-tight">Wolf Pack</h1>
                            <p className="text-xs text-gray-400">Community & Collaboration</p>
                        </div>
                    </div>
                </header>
                ...
                <div className="flex-1 p-6 overflow-y-auto z-10">
                    ...
                    {error && (
                        <div className="glass-card rounded-xl p-6 border-red-500/20 bg-red-500/5">
                            <p className="text-red-400 mb-2 font-medium">Error loading Wolf Pack data</p>
                        ...
                        <div className="space-y-6">
                            ...
                            {data.in_pack ? (
                                <>
                                    ...
                                    <div className="grid grid-cols-3 gap-6">
                                        <div className="glass-card rounded-xl p-6">
                                            <div className="flex items-center justify-between mb-2">
                                                <span className="text-sm text-gray-400">Pack Members</span>
                                        ...
                                        <div className="glass-card rounded-xl p-6">
                                            <div className="flex items-center justify-between mb-2">
                                                <span className="text-sm text-gray-400">Shared Rebates</span>
                                                <TrendingUp className="h-4 w-4 text-[#00FF94]" />
                                            </div>
                                    ...
                                    {/* Pack Members Table */}
                                    <div className="glass-card rounded-xl p-6">
                                        <h2 className="text-lg font-bold mb-4">Pack Members</h2>
                                                        ...
                                                        <tr key={idx} className="border-b border-white/5 hover:bg-white/5">
                                                            ...
                                                            <td className="py-3">
                                                                <span className={cn(
                                                                    ...
                                                                    member.role === 'member' && "bg-gray-500/20 text-gray-400"
                                                                )}>
                                                                    {member.role}
                                                                </span>
                                                            </td>
                                    ...
                                    {/* Invite Link */}
                                    <div className="glass-card rounded-xl p-6">
                                        <h2 className="text-lg font-bold mb-4">Invite More Members</h2>
                                ...
                                <div className="glass-card rounded-xl p-12 text-center">
                                    ...
                                    <h2 className="text-2xl font-bold mb-3">Join a Wolf Pack</h2>
                                    <p className="text-gray-400 mb-6 max-w-md mx-auto">
                                        Collaborate with other traders, share rebates, and grow together.
                                        Enter a pack invite code to get started.
                                    </p>
                                    ...
                                    <div className="mt-8 pt-8 border-t border-white/10">
                                        <p className="text-sm text-gray-500 mb-3">Or create your own pack:</p>
