                    ...
                    {liquidationData && leverageData && !loading && (
                        <div className="space-y-6">
                            ...
                            <div className="glass-card rounded-xl p-6">
                                <h2 className="text-lg font-bold mb-4">{t('overall_score')}</h2>
                                    ...
                                    <div className="flex-1 space-y-3">
                                        <div>
                                            <div className="flex justify-between text-sm mb-1">
                                                <span className="text-gray-400">{t('liquidation_distance')}</span>
                                        ...
                                        <div className="p-3 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                <span className="text-sm font-medium text-yellow-500">{t('liquidation_price')}</span>
                                            </div>
                            ...
                            {/* Leverage Analysis */}
                            <div className="glass-card rounded-xl p-6">
                                <h2 className="text-lg font-bold mb-4">{t('leverage_analysis')}</h2>
                                <div className="grid grid-cols-3 gap-6">
                                    <div>
                                        <span className="text-sm text-gray-400 block mb-2">{t('current_leverage')}</span>
                                        <div className="text-3xl font-bold text-white">
                                            {leverageData.current_leverage}x
                                        </div>
                                    </div>
                                    <div>
                                        <span className="text-sm text-gray-400 block mb-2">{t('recommended')}</span>
                                        <div className="text-3xl font-bold text-[#00FF94]">
                                            {leverageData.recommended_leverage}x
                                        </div>
                                    </div>
                                    <div>
                                        <span className="text-sm text-gray-400 block mb-2">{t('risk_level')}</span>
                            ...
                            {/* Positions Exposure */}
                            <div className="glass-card rounded-xl p-6">
                                <h2 className="text-lg font-bold mb-4">{t('position_exposure')}</h2>
                                        ...
                                        <table className="w-full">
                                            <thead>
                                                <tr className="text-left text-sm text-gray-400 border-b border-white/10">
                                                    ...
                                                    <th className="pb-3 text-right">{t('size')}</th>
                                                    <th className="pb-3 text-right">{t('leverage')}</th>
                                                    <th className="pb-3 text-right">{t('liq_price')}</th>
                                                </tr>
                                            </thead>
                            ...
                            {fundingData && (
                                <div className="glass-card rounded-xl p-6">
                                    <h2 className="text-lg font-bold mb-4">{t('funding_monitor')}</h2>
                                        ...
                                        <div className="overflow-x-auto">
                                            <table className="w-full">
                                                <thead>
                                                    <tr className="text-left text-sm text-gray-400 border-b border-white/10">
                                                        <th className="pb-3">{t('symbol')}</th>
                                                        <th className="pb-3 text-right">{t('rate')}</th>
                                                        <th className="pb-3">{t('next_funding')}</th>
                                                        <th className="pb-3 text-right">{t('est_payment')}</th>
                                                    </tr>
                                                </thead>
                                                <tbody className="text-sm">
