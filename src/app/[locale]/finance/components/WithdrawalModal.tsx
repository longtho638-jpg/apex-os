...
import { ArrowRight, Building2, Check, ChevronLeft, Loader2, Wallet } from 'lucide-react';
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 'success' && (
              ...
              >
                ...
                <Button onClick={handleClose} className="bg-white/10 hover:bg-white/20 text-white w-full max-w-[200px]">
                  Done
                </Button>
              </motion.div>
            )}
