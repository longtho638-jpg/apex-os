    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 max-w-md">
            <div className="space-y-2">
                <label htmlFor="amount" className="text-sm font-medium text-gray-300">Amount (USDT)</label>
                <Input
                    id="amount"
                    type="number"
                    value={amount}
                ...
                />
                <p id="balance-hint" className="text-xs text-gray-500">Available: {balance} USDT</p>
            </div>

            <div className="space-y-2">
                <label htmlFor="payment-method" className="text-sm font-medium text-gray-300">Payment Method</label>
                ...
                {paymentMethods.length === 0 && (
                    <p className="text-xs text-yellow-500" role="alert">Please add a payment method first.</p>
                )}
            </div>
