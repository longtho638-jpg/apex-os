                        ...
                        <div className="space-y-4 py-4">
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(v) => setNewMethod({ ...newMethod, type: v })}
                                >
                            ...
                            <Button onClick={handleAdd} className="w-full">Save Method</Button>
                        </div>
                    </DialogContent>
                </Dialog>
            </div>
                ...
                {methods.map(method => (
                    <Card key={method.id} className="p-4 bg-gray-900 border-gray-800 flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            {method.type === 'crypto_wallet' ? <CreditCard className="text-purple-400" /> : <Landmark className="text-blue-400" />}
                            <div>
