...
import type { PaymentMethod, Transaction, Wallet } from '@/types/finance';
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (txData.success) {
        ...
        setCommissionBalance(comms > 0 ? comms : 1250.5); // Mock fallback if 0
      }
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              ...
              <GlassCard className="p-6 flex flex-col justify-between border-emerald-500/20 bg-emerald-500/5">
                <div>
                  <div className="text-sm text-emerald-400 font-bold uppercase tracking-wider mb-1">
                    Commission Wallet
                  </div>
