            ...
            <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid gap-4 mb-12">
                        {systems.map((sys) => (
                            <div key={sys.name} className="flex items-center justify-between p-6 bg-white/5 border border-white/10 rounded-xl">
                        ...
                        <div className="space-y-8">
                            <div className="border-l-2 border-emerald-500 pl-6 relative">
                                ...
                                <p className="text-zinc-400">
                                    We successfully completed the scheduled upgrade to our matching engine.
                                    Latency has been reduced by 15%.
                                </p>
                            </div>
                            <div className="border-l-2 border-zinc-800 pl-6 relative">
                                ...
                                <p className="text-zinc-400">
                                    We observed a brief spike in API latency due to high volume.
                                    Auto-scaling triggered and resolved the issue within 2 minutes.
                                </p>
                            </div>
                        </div>
                    </div>
