                            ...
                            <GlassCard className="p-6 border-l-4 border-l-emerald-500">
                                <div className="flex items-start justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-zinc-400 mb-4">Complete these steps to unlock full Money Engine potential.</p>
                                        ...
                                        <GlassCard className="p-8">
                                            ...
                                            <div className="space-y-6 max-w-xl">
                                                ...
                                                <div className="grid gap-6">
                                                    <div>
                                                        <label className="text-xs text-zinc-400 block mb-1.5 uppercase tracking-wider">{t('display_name_label')}</label>
                                                        <input
                                                            type="text"
                                                            value={displayName}
                                                    ...
                                                    <div>
                                                        <label className="text-xs text-zinc-400 block mb-1.5 uppercase tracking-wider">{t('email_label')}</label>
                                                        <input
                                                            type="email"
                                                            value={profile.email}
                                                            disabled
                                        ...
                                        <GlassCard className="p-8">
                                            ...
                                            {apiKeys.length > 0 ? (
                                                <div className="grid gap-4">
                                                    {apiKeys.map(key => (
                                                        <div key={key.id} className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/10 group hover:border-emerald-500/30 transition-colors">
                                                            <div className="flex items-center gap-4">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div className="text-sm text-zinc-400">{key.label || 'No label'} • Added {new Date(key.created_at).toLocaleDateString()}</div>
                                                                </div>
                                                            </div>
                                                            <button
                                        ...
                                        <GlassCard className="p-8">
                                            ...
                                            <div className="grid gap-6 max-w-2xl">
                                                ...
                                                <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                                                    <label className="text-xs text-zinc-400 block mb-2 uppercase tracking-wider">{t('language')}</label>
                                                    <select
                                                ...
                                                <div className="p-6 rounded-xl bg-yellow-500/5 border border-yellow-500/20">
                                                    <div className="flex items-start gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <button disabled className="px-4 py-2 bg-yellow-500/10 text-yellow-500 rounded-lg text-sm font-medium opacity-50 cursor-not-allowed">
                                                                Coming Soon
                                                            </button>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="p-6 rounded-xl bg-blue-500/5 border border-blue-500/20">
                                                    <div className="flex items-start gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <button disabled className="px-4 py-2 bg-blue-500/10 text-blue-500 rounded-lg text-sm font-medium opacity-50 cursor-not-allowed">
                                                                Coming Soon
                                                            </button>
                                                        </div>
                                                    </div>
                ...
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50">
                    <GlassCard className="p-8 w-full max-w-md m-4 border-emerald-500/20">
                        ...
                        <div className="space-y-5">
                            ...
                            <div>
                                <label className="text-xs text-zinc-400 block mb-1.5 uppercase tracking-wider">{t('api_key_label')}</label>
                                <input
                                    type="text"
                                    value={newKey.apiKey}
                            ...
                            <div>
                                <label className="text-xs text-zinc-400 block mb-1.5 uppercase tracking-wider">{t('api_secret_label')}</label>
                                <input
                                    type="password"
                            ...
                            <div>
                                <label className="text-xs text-zinc-400 block mb-1.5 uppercase tracking-wider">{t('label_optional')}</label>
                                <input
                                    type="text"
                                    value={newKey.label}
