    ...
    <div className="min-h-screen bg-[#030303] text-white selection:bg-red-500/30 overflow-x-hidden">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-8 leading-tight">
              ...
              <span className="text-red-500 relative inline-block mx-2">
                 30%
                 <svg className="absolute -bottom-2 left-0 w-full h-3 text-red-500/50" viewBox="0 0 100 10" preserveAspectRatio="none">
                    <path d="M0 5 Q 50 10 100 5" stroke="currentColor" strokeWidth="3" fill="none" />
                 </svg>
              </span> 
              {t('hero.title').split('30%')[1]} <br />
              <GradientText from="from-white" to="to-zinc-400">{t('hero.subtitle').split('.')[0]}</GradientText>.
            </h1>
            ...
            {[
              ...
              <GlassmorphicCard key={i} className="hover:!border-red-500/50 group">
                ...
                <div className="pt-6 border-t border-white/5 flex justify-between items-center">
                    <span className="text-xs font-bold uppercase tracking-widest text-red-500">{t('problem.loss_label')}</span>
            ...
            <div className="relative">
                ...
                <div className="bg-black border border-emerald-500/30 rounded-2xl p-8 relative z-10 shadow-2xl">
                    ...
                    <div className="text-center mb-8">
                        <div className="text-zinc-400 text-sm uppercase tracking-widest mb-2">{t('solution.total_recovered')}</div>
                        <div className="text-5xl font-mono font-bold text-white">$<AnimatedNumber value={5432.91} /></div>
                    </div>
                    <div className="space-y-3">
                        {[1,2,3].map((_, i) => (
                            <div key={i} className="flex items-center justify-between p-3 bg-emerald-500/5 rounded-lg border border-emerald-500/10">
      ...
      <section className="py-32 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <Button3D 
            onClick={handleStartTrial} 
            className="text-xl h-20 px-12 !bg-white !text-black hover:!bg-zinc-200"
          >
            {t('pricing.cta')}
          </Button3D>
          <p className="mt-8 text-sm text-zinc-500">
            Includes 7-day money-back guarantee on paid plans.
          </p>
        </div>
      </section>
