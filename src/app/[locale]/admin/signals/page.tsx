...
import { BarChart3, BrainCircuit, CheckCircle2, Target, XCircle, Zap } from 'lucide-react';
          ...
          <div className="p-6 space-y-6">
            ...
            >
              ...
              <GlassCard className="p-6">
                ...
                <div className="text-4xl font-black text-purple-400">{loading ? '...' : stats.totalSignals}</div>
              </GlassCard>
              ...
              <GlassCard className="p-6">
                ...
                <div className="text-4xl font-black text-blue-400">ACTIVE</div>
                ...
                {[1, 2, 3].map((i) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span
                        className={`text-xs px-2 py-0.5 rounded ${i === 2 ? 'bg-red-500/20 text-red-400' : 'bg-emerald-500/20 text-emerald-400'}`}
                      >
                        {i === 2 ? 'SELL' : 'BUY'}
                      </span>
                    </div>
