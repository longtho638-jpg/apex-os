...
export default function ExchangeConfigPage() {
      ...
      setConfigs([
        {
          ...
          standard_maker_fee: 0.001,
          standard_taker_fee: 0.001,
          apex_partner_rate: 0.2,
          partner_uuid: '',
          is_active: true,
        },
        {
          exchange_name: 'OKX',
          standard_maker_fee: 0.0008,
          standard_taker_fee: 0.001,
          apex_partner_rate: 0.45,
          partner_uuid: '',
          is_active: true,
        },
        {
  ...
  const handleSave = async () => {
    ...
    const { error } = await supabase.from('exchange_configs').upsert(updates, { onConflict: 'exchange_name' });
