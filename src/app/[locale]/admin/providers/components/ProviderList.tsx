...
import { MoreVertical, RefreshCw, History, Trash2, CheckSquare, Square, MinusSquare, Activity } from 'lucide-react';
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {providers.map((provider) => (
                                <tr key={provider.id} className={`border-b border-white/5 hover:bg-white/5 transition-colors ${selectedIds.has(provider.id) ? 'bg-blue-500/10' : ''}`}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <code className="text-sm text-gray-300 font-mono">
                                            {provider.partner_uuid || '-'}
                                        </code>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <span className={`px-2 py-1 text-xs font-medium rounded-md border ${getStatusBadgeColor(provider.status)}`}>
                                            {provider.status}
                                        </span>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
