                      ...
                      <td className="p-4 text-right">
                        {req.status === 'pending' && (
                          <div className="flex gap-2 justify-end">
                            <button className="px-3 py-1 bg-emerald-500 hover:bg-emerald-600 rounded text-xs font-bold">
                              Mark Paid
                            </button>
                            <button className="px-3 py-1 bg-red-500/20 hover:bg-red-500/40 text-red-400 rounded text-xs font-bold">
                              Reject
                            </button>
                          </div>
                        )}
