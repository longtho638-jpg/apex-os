          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
                <GlassCard className="p-6 text-center">
                    <div className={`w-4 h-4 rounded-full mx-auto mb-4 ${isRunning ? 'bg-emerald-500 animate-pulse' : 'bg-red-500'}`} />
                    ...
                    >
                        {isRunning ? <><Square className="w-5 h-5" /> TERMINATE</> : <><Play className="w-5 h-5" /> INITIATE</>}
                    </button>
                </GlassCard>
                ...
                <GlassCard className="p-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input type="number" defaultValue={1000} className="w-full bg-zinc-900 border border-white/10 rounded p-2 text-sm" />
                        </div>
                        <div>
                            <label className="text-xs text-zinc-500 block mb-1">Target Spread (%)</label>
                            <input type="number" defaultValue={0.2} className="w-full bg-zinc-900 border border-white/10 rounded p-2 text-sm" />
                        </div>
