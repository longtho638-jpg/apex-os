...
export default function AuditLogsPage() {
    ...
    const filteredLogs = logs.filter(log => {
        if (filter === 'security' && !log.action.includes('SECURITY') && !log.action.includes('IP') && !log.action.includes('MFA')) {
            return false;
        }
        ...
        <div className="container mx-auto p-6 max-w-7xl">
            ...
            <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800/30 rounded-lg">
                <p className="text-sm text-blue-800 dark:text-blue-200">
                    <strong>ℹ️ Retention:</strong> Audit logs are retained for 90 days.
