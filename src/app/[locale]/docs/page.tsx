...
import { Search, Book, Code, Zap, Shield, ChevronRight, FileText, Terminal } from 'lucide-react';
                    ...
                    {categories.map((cat, i) => (
                        ...
                        >
                            ...
                            <ul className="space-y-3">
                                {cat.links.map(link => (
                                    <li key={link}>
                                        <a href="#" className="flex items-center gap-2 text-zinc-300 hover:text-emerald-400 transition-colors text-sm font-medium">
