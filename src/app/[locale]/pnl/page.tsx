            ...
            <main className="flex-1 flex flex-col overflow-hidden">
                ...
                <header className="h-16 flex items-center justify-between px-6 z-10 border-b border-white/5 bg-[#030303]/50 backdrop-blur-md">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-lg font-bold tracking-tight">Theo Dõi PnL</h1>
                            <p className="text-xs text-gray-400">Profit & Loss Tracking</p>
                        </div>
                    </div>
                ...
                <div className="flex-1 p-6 overflow-y-auto z-10">
                    ...
                    {error && (
                        <div className="glass-card rounded-xl p-6 border-red-500/20 bg-red-500/5">
                            <p className="text-red-400 mb-2 font-medium">Error loading PnL data</p>
                    ...
                    {data && !loading && (
                        <div className="space-y-6">
                            ...
                            {/* PnL Chart */}
                            <div className="glass-card rounded-xl p-6">
                                <h2 className="text-lg font-bold mb-4">PnL Over Time</h2>
                            ...
                            <div className="glass-card rounded-xl p-6">
                                <h2 className="text-lg font-bold mb-4">Performance by Symbol</h2>
                            ...
                            {data.total_trades === 0 && (
                                <div className="glass-card rounded-xl p-12 text-center">
                                    ...
                                    <p className="text-gray-400">You haven't made any trades in this period.</p>
                                </div>
                            )}
                        </div>
                    )}
