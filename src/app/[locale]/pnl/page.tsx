...
import { RefreshCw, Share2, TrendingDown, TrendingUp } from 'lucide-react';
...
import type { PnLPeriod } from '@/lib/api/pnl';
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-6">
                ...
                <div className="glass-card rounded-xl p-6">
                  ...
                  <div className={cn('text-3xl font-bold', realPnL >= 0 ? 'text-[#00FF94]' : 'text-red-500')}>
                    {realPnL >= 0 ? '+' : ''}
                    {realPnL.toFixed(2)} USD
                  </div>
                </div>
                ...
                <div className="glass-card rounded-xl p-6">
                  ...
                  <div className="text-3xl font-bold text-white">{data.win_rate.toFixed(1)}%</div>
                  <div className="mt-2 h-2 bg-white/10 rounded-full overflow-hidden">
                    <div className="h-full bg-[#00FF94]" style={{ width: `${data.win_rate}%` }} />
                  </div>
                </div>
                ...
                <div className="glass-card rounded-xl p-6">
                  ...
                  <div className="text-3xl font-bold text-white">{data.total_trades}</div>
                </div>
              </div>
