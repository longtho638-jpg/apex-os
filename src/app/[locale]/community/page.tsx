...
import { Users, MessageSquare, TrendingUp, Shield, Zap } from 'lucide-react';
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            <GlassCard className="p-6">
                                ...
                                <div className="space-y-4">
                                    {whales.map((whale) => (
                                        <div key={whale.id} className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/5">
                            ...
                            <GlassCard className="p-6">
                                ...
                                <div className="space-y-4">
                                    <div className="p-4 bg-white/5 rounded-xl border border-white/5 hover:border-blue-500/30 transition-colors cursor-pointer">
                                        ...
                                        <p className="text-sm text-zinc-400 mb-2">Analysis of the current market structure and institutional inflows...</p>
                        ...
                        <div className="space-y-6">
                            <GlassCard className="p-6">
                                ...
                                <div className="space-y-3">
                                    {teams.length > 0 ? teams.map((team, i) => (
                                        <div key={team.id} className="flex items-center justify-between border-b border-white/5 pb-2 last:border-0">
                                            <div className="flex items-center gap-3">
                                                <span className={`font-bold w-4 ${i === 0 ? 'text-yellow-400' : 'text-zinc-500'}`}>#{i + 1}</span>
                                                <span className="font-medium">{team.name}</span>
                                            </div>
                                            <span className="text-xs text-emerald-400 font-mono">${(team.total_volume / 1000000).toFixed(1)}M</span>
                                        </div>
                                    )) : (
                            ...
                            <GlassCard className="p-6 bg-gradient-to-br from-purple-900/20 to-blue-900/20 border-purple-500/20">
                                ...
                                <p className="text-sm text-zinc-400 mb-4">Unlock exclusive channels and signals by upgrading your tier.</p>
