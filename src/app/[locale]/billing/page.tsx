...
import { ArrowUpRight, Bot, CreditCard, TrendingUp } from 'lucide-react';
          ...
          <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4 mt-4">
                ...
                <div className="p-3 bg-white/5 rounded-xl text-center">
                  ...
                  <div className="text-lg font-bold">
                    {currentTierData.agentSlots === Infinity ? '∞' : currentTierData.agentSlots}
                  </div>
              ...
              <GlassCard className="p-6">
                ...
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="text-emerald-400">
                    ${nextTier.volumeThreshold.toLocaleString()} to unlock {nextTier.name}
                  </span>
                </div>
            ...
            <GlassCard className="p-6">
              ...
              <div className="space-y-3 text-sm text-gray-400">
                <p>
                  1. You trade for <span className="text-white font-bold">FREE</span> — no monthly subscription
                </p>
                <p>2. A small spread ({(currentTierData.spreadBps / 100).toFixed(2)}%) is applied per trade</p>
                <p>
                  3. You earn{' '}
                  <span className="text-emerald-400 font-bold">
                    {(currentTierData.selfRebateRate * 100).toFixed(0)}% back
                  </span>{' '}
                  as self-rebate
                </p>
