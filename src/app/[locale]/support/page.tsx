...
import { Mail, MessageCircle, Search, Zap } from 'lucide-react';
      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 mb-20">
          {[
            ...
            <div
              key={i}
              className="p-8 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/[0.07] transition-colors cursor-pointer group"
            >
