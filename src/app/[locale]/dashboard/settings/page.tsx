...
import { Key, Bell, Shield, User, Save, Link, AlertTriangle } from 'lucide-react';
...
export default function SettingsPage() {
    const [activeTab, setActiveTab] = useState<'account' | 'security' | 'notifications' | 'api' | 'connections' | 'risk'>('connections');
