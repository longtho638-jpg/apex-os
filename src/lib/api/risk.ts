 ...
 */
export async function fetchLiquidationRisk(userId: string, token?: string): Promise<LiquidationRisk | null> {
  try {
 ...
 */
export async function fetchLeverageCheck(userId: string, token?: string): Promise<LeverageCheck | null> {
  try {
 ...
 */
export async function fetchFundingRates(userId: string, token?: string): Promise<FundingRates | null> {
  try {
