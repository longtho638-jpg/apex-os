...
export async function fetchUserProfile(userId: string, token: string): Promise<UserProfile> {
...
export async function fetchAPIKeys(userId: string, token: string): Promise<APIKeyMetadata[]> {
...
export async function createAPIKey(
    ...
    const response = await apiClient<{ success: boolean; key_id: string; message: string }>(
        '/user/api-keys',
        {
            method: 'POST',
            headers: {
...
export async function fetchPreferences(userId: string, token: string): Promise<UserPreferences> {
