...
export const COMPONENTS = {
    // Buttons
    button: {
        primary: 'px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl font-bold transition-all shadow-[0_0_20px_rgba(16,185,129,0.2)]',
        ...
        danger: 'px-4 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/20 rounded-xl transition-all',
    },
    ...
    input: {
        ...
        error: 'w-full px-4 py-3 bg-red-500/5 border border-red-500/20 rounded-xl text-white focus:outline-none focus:border-red-500/50 transition-colors',
    },
