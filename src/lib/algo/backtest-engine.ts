...
export function runBacktest(nodes: any[], edges: any[], candles: Candle[]): BacktestResult {
  ...
  const rsiThreshold = logicNode ? parseInt(logicNode.data.condition.replace(/[^0-9]/g, '')) : 30;
