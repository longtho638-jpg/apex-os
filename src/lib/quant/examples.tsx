...
function generateEnhancedSignal(
    ...
    const isVolatilityNormal = regime.type !== 'VOLATILE' && volatility.bollingerBands.percentB > 0.1 && volatility.bollingerBands.percentB < 0.9;
...
export function ExampleQuantDashboard({ symbol }: { symbol: string }) {
    ...
    const confidence = signal !== 'WATCHING'
        ? calculateSignalConfidence(features, signal)
        : 0;
            ...
            <div className="mb-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                    ...
                    <div>
                        ...
                        <span className="text-white font-mono">
                            {features.volatility.atr14.toFixed(2)}
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                    <div>
                        ...
                        <span className={`font-bold ${features.trend.trend === 'BULLISH' ? 'text-green-400' :
                                features.trend.trend === 'BEARISH' ? 'text-red-400' :
                                    'text-yellow-400'
                            }`}>
                    ...
                    <div>
                        ...
                        <span className="text-white">{features.regime.type}</span>
                    </div>
                </div>
            </div>
