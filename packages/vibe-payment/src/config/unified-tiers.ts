...
export const UNIFIED_TIERS: Record<TierId, UnifiedTier> = {
  EXPLORER: {
    ...
    spreadBps: 30,
    selfRebateRate: 0.1,
    commissionRates: { l1: 0.1, l2: 0, l3: 0, l4: 0, total: 0.2 },
    agentSlots: 1,
  ...
  OPERATOR: {
    ...
    spreadBps: 20,
    selfRebateRate: 0.2,
    commissionRates: { l1: 0.2, l2: 0.05, l3: 0, l4: 0, total: 0.45 },
    agentSlots: 3,
  ...
  ARCHITECT: {
    ...
    spreadBps: 12,
    selfRebateRate: 0.3,
    commissionRates: { l1: 0.25, l2: 0.1, l3: 0.05, l4: 0, total: 0.7 },
    agentSlots: 7,
    agentTypes: [
      'signal-follower',
      'dca-bot',
  ...
  SOVEREIGN: {
    ...
    spreadBps: 5,
    selfRebateRate: 0.5,
    commissionRates: { l1: 0.3, l2: 0.15, l3: 0.1, l4: 0.05, total: 1.1 },
    agentSlots: Infinity,
    agentTypes: [
      'signal-follower',
      'dca-bot',
