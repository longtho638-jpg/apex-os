-- ============================================================================
-- MANUAL MIGRATION SCRIPT (Week 3 Blitzkrieg)
...
CREATE POLICY subscriptions_user_policy ON subscriptions FOR SELECT USING (auth.uid() = user_id);
...
CREATE INDEX IF NOT EXISTS idx_usage_charges_paid ON usage_charges(paid);
